...
| Consignation seed des gestes du 17 (réservations fanion, capacités occupant-unique, 3 décochages de permanentes) | ✅ 2026-09-01 (PR en cours) — ⚠ les **2 contraintes de genèse** (« SM mutualisés ≥ 20:30 », « Nicolas lun+ven ») attendent **P2-59** (les datées s'accrochent à la mère partagée : conception à reprendre, voir [`contraintes-genese-par-plan.md`](contraintes-genese-par-plan.md)) |
| P2-59 contraintes de genèse par plan (structurant, bloque la fin du seed du 17) + P2-60 unité de placement = bloc ([`unite-de-placement-bloc.md`](unite-de-placement-bloc.md)) | ⬜ ouverts le 2026-09-01, arbitrages/GO fondateur attendus |
