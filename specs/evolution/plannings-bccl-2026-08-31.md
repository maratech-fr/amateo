...
| P2-60 unité de placement = bloc ([`unite-de-placement-bloc.md`](unite-de-placement-bloc.md)) | 🟠 PR-1 backend LIVRÉE 2026-09-03 (garde 422 aux deux portes + lecture) ; PR-2 frontend (filtre du sélecteur) reste ouverte |
