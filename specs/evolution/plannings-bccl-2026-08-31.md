...
| **Idée à cadrer plus tard : ramener le découpage d'une fermeture à 3 blocs max** (fondateur, 2026-09-04) — aujourd'hui P2-41 permet un découpage semaine par semaine ; l'idée réduirait le picker à début partiel · milieu de semaines complètes · fin partielle. Question préalable avant tout cadrage : quelqu'un a-t-il déjà eu besoin du découpage semaine par semaine ? (BCCL : non, constaté) | ⬜ idée notée, pas une décision |
