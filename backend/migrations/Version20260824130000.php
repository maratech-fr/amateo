...
final class Version20260824130000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if (\is_string($appRole)) {
            $this->addSql('GRANT SELECT, INSERT, UPDATE, DELETE ON fbi_ingestion TO ' . $appRole);
            ...
            $this->addSql(\sprintf(
                'CREATE POLICY tenant_isolation ON public.fbi_ingestion FOR ALL TO ' . $appRole . ' USING (%s) WITH CHECK (%s)',
