...
final class Version20260824120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if (\is_string($appRole)) {
            $this->addSql('GRANT SELECT, INSERT, UPDATE, DELETE ON match_module_visit TO ' . $appRole);
            ...
            $this->addSql(\sprintf(
                'CREATE POLICY tenant_isolation ON public.match_module_visit FOR ALL TO ' . $appRole . ' USING (%s) WITH CHECK (%s)',
