    ...
    private function uncoveredCustomPaths(): array
    {
        ...
        return [
            ...
            '/api/reservations/group' => new PathItem(post: new Operation(
                ...
                tags: ['Reservation'],
                responses: [
                    '201' => $this->schemas->jsonResponse('Shared-training group reserved on one slot: N reservations (one per member) written in a single flush; the response carries their ids', [
                        'type' => 'object',
                        'properties' => [
