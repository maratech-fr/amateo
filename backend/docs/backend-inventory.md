...
Last verified @ 2026-09-04 (D3 v1 PR-2, cockpit). Section « Cockpit temporel » recalée : D3 v1 est
SOLDÉE ENTIÈRE (PR-1 backend + PR-2 cockpit) — le geste d'édition à l'écran n'est plus « ouvert »,
il pointe désormais `accueil-cockpit-temporel.md` §5bis. ⚠ Vérification volontairement ÉTROITE : le
reste de l'inventaire n'a pas été reconfronté au code ce jour — historique des passes :
