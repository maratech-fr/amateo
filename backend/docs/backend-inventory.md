...
Last verified @ 2026-09-04 (P2-62 — suppression d'une réservation de case bloc-complète). Entrée
`Reservation` recalée : la DELETE (troisième porte, après POSE et DÉCLARATION/ÉDITION de bloc)
emporte désormais toute la case bloc-complète — confronté à
`ReservationGroupOccupancy::blockCompleteCaseSiblings` (`backend/src/Service/ReservationGroupOccupancy.php:200`)
et `ReservationStateProcessor::processDelete` (`backend/src/State/Processor/ReservationStateProcessor.php:63-99`).
