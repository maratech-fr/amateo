...
Last verified @ 2026-09-14 (E1 — ré-affectation d'un libellé de salle, backend seul —
`documentation-update`). Re-confronté au code : la nouvelle route `GET /api/venues/fbi-labels`
(`VenueExternalLabelController::inventory`, `priority: 10`) sert
