...
Last verified @ 2026-09-14 (rotation `documentation-update`, PR P4-203 « solveur de placement /
règle D1 » — fichier hors sujet de la PR, contrôle de fraîcheur). Re-confronté au code :
