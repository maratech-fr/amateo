...
Last verified @ 2026-09-10 (rotation de fraîcheur `documentation-update`, PR P4-194/P4-195 « coupes
FFBB » — fichier hors sujet). Reconfirmé sans écart : `CONTRACT_VERSION` `2.20` des deux côtés
...
`ScheduleStatus` à cinq états exactement (`backend/src/Enum/ScheduleStatus.php`) ✓. Rien à corriger.
