...
Last verified @ 2026-09-14 (rotation `documentation-update`, P4-198 — fichier hors sujet de
...
`admin_all` TO `amateo_owner` (assertions `:195-198`) ✓. Rien de faux trouvé cette passe.
