...
import type { Fixture, PendingDeviation, ResolveDeviationInput } from "./api";
 ...
 */
export function ReviewQueueRow({ fixture, onValidateLine, onResolve, onPlace, busy }: ReviewQueueRowProps) {
