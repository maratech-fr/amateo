...
vi.mock("./api", () => ({
  getFixtures: vi.fn(() =>
    Promise.resolve([
      ...
      { id: "fx-away", teamId: "team-1", seasonId: "s", competitionId: null, matchDate: "2026-10-04", homeAway: "AWAY", opponentLabel: "Grenoble", status: "UNPLACED", venueId: null, kickoffTime: null, externalRef: null, fbiVenueLabel: "Halle Clemenceau", placementSource: null, unplacedReason: null, reviewState: "NEW" as const, reviewedAt: null, pendingDeviations: [], ffbbRencontreId: null, opponentOrganismeCode: null, opponentTeamKey: null, suggestedVenueId: null },
...
describe("ConsultPage (PR-2a — onglet Consulter, lecture seule)", () => {
  ...
  it("un domicile de la semaine sans gymnase ⇒ compteur discret sous la grille", async () => {
    vi.mocked(matchesApi.getFixtures).mockResolvedValueOnce([
      ...
      { id: "fx-home-noroom", teamId: "team-1", seasonId: "s", competitionId: null, matchDate: "2026-10-03", homeAway: "HOME", opponentLabel: "Sans salle", status: "UNPLACED", venueId: null, kickoffTime: null, externalRef: null, fbiVenueLabel: "GYMNASE MATEO", placementSource: null, unplacedReason: null, reviewState: "NEW", reviewedAt: null, pendingDeviations: [], ffbbRencontreId: null, opponentOrganismeCode: null, opponentTeamKey: null, suggestedVenueId: null },
    ] as never);
    renderConsult();
