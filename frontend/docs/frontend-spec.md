...
│   │                           # FbiEntryList en modale) ; WeekCounters (barre de 3 compteurs,
│   │                           # remplace le rail 5 étapes lib/loopSteps.ts) ; CalendarControls
