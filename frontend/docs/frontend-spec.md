...
Last verified @ 2026-09-13 (`documentation-update`, P4-200 C2 « refonte de la modale Engagements
FFBB »). Recalé : la ligne `/matchs` pointe désormais vers `module-matchs.md` § « Appariement
FFBB » pour le détail de l'écran refondu (`FfbbEngagementsDialog` en `Modal size="xl"`, compteur,
chip de suggestion) — ce fichier ne redécrit pas le comportement, seule la carte des boutons.
...
│   │                           # VenueLabelsSection, 7ᵉ section, retrait des alias FFBB, P4-196) +
