...
`^4.13.0`, `storybook`/`@storybook/react-vite` `^10.5.10` — toutes les majeures citées (§ Outils de
test) tiennent encore. Historique des passes : `git log -p --follow frontend/docs/frontend-strategy.md`.)
