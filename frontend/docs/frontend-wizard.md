...
Last verified @ 2026-08-31 (P2-51 PR-4/D13 — la section Mutualisation de la modale « Liens » recalée : `SharedTrainingBlockPanel` vérifié monté seul dans `TeamLinksModal.tsx`, `MutualisationPanel` démonté, vocabulaire « groupe à mutualiser » confronté aux textes rendus ; trou de transition sous-ligne consigné. Vérification précédente reprise sans re-contrôle au-delà : `AutofillUnresolvedReason`
