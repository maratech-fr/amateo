...
Last verified @ 2026-09-04 (P4-172, `documentation-update`). §2 axe « Cycle de vie des plans »
gagne `Security/PeriodWindowRaceTest` (re-vérifié : le fichier existe, 2 tests `phase1`+
`integration`, absent de `docs/testing/blocking-tests.md` et de `ci.yml` — confirmé non
bloquant, tourne dans `unit-tests`). Un stamp REMPLACE, l'historique vit dans git :
