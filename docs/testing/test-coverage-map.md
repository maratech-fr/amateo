...
Last verified @ 2026-09-04 (P2-62, `documentation-update`). §2 axe « Sémantique des contraintes »
gagne les 2 cas `ReservationApiTest` de la cascade de case bloc-complète (re-vérifié : les deux
méthodes existent dans `backend/tests/Integration/Api/ReservationApiTest.php`, testsuite
`Integration` depuis P4-169 — donc jouées par `unit-tests`, absentes de `blocking-tests.md`).
