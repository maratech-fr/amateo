...
Last verified @ 2026-09-11 (rotation de fraîcheur `documentation-update`, sans rapport avec le
sujet de la PR — P4-196, écran de retrait des libellés FFBB). Reconfirmé sans écart : PHPUnit
**11.5.55** (`backend/composer.lock:11842`) ✓ · `TenantFilterListener` priorité **7, APRÈS le firewall**
...
**2.20** des deux côtés (`engine/CONTRACT_VERSION`, `MatchPlacementPayloadBuilder::CONTRACT_VERSION:65`) ✓.
